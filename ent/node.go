...
func (l *Like) Node(ctx context.Context) (node *Node, err error) {
	...
	node.Edges[0].IDs, err = l.QueryRestaurant().
		Select(restaurant.FieldID).
		Ints(ctx)
	if err != nil {
		return nil, err
	}
...
func (r *Restaurant) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     r.ID,
		Type:   "Restaurant",
		Fields: make([]*Field, 4),
	...
	if buf, err = json.Marshal(r.URL); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(r.Phone); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(r.Price); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
	...
	node.Edges[0].IDs, err = r.QueryLikes().
		Select(like.FieldID).
		Ints(ctx)
	if err != nil {
		return nil, err
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case restaurant.Table:
		n, err := c.Restaurant.Query().
			Where(restaurant.ID(id)).
			CollectFields(ctx, "Restaurant").
			Only(ctx)
		if err != nil {
			return nil, err
		}
