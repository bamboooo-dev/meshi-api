...
type RestaurantService interface {
	Like(ctx context.Context, meshiDB *ent.Client, restarurantID int) (*ent.Like, error)
}
...
func (s *restaurantService) Like(ctx context.Context, meshiDB *ent.Client, restarurantID int) (*ent.Like, error) {
